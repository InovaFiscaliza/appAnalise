classdef DBHandler
    ...
    methods
        ...
        function output = getSpectrumLocalities(obj, equipmentId)
            ...
            sqlQuery = ...
                ...
                "WHERE f.FK_EQUIPMENT = " + string(round(equipmentId)) + " " + ...
        ...
        function output = getSpectrumFileData(obj, filters)
            ...
            whereConditions = obj.buildSpectrumWhereConditions(filters, false);
            localitySql = obj.buildSpectrumLocalitySql();
            [pageSize, offset] = obj.getPaginationInfo(filters);
            ...
            sqlQuery = ...
                ...
                "GROUP BY repos.ID_FILE, repos.NA_PATH, repos.NA_FILE, repos.NA_EXTENSION, repos.VL_FILE_SIZE_KB, e.NA_EQUIPMENT " + ...

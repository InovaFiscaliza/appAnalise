classdef UserData
    ...
    properties
        ...
        Emissions = table( ...
            ...
            string.empty, ...
            'VariableNames', {'Frequency', 'FrequencyIdx', 'BandWidthkHz', 'IsTruncated', 'Description', 'Algorithms', 'Measures', 'ChannelAssigned', 'Classification', 'AuxAppData', 'Uuid'} ...
        )
        ...
        % Matriz binária de ocupação por ponto de frequência relacionada à
        % ocupação selecionada, registrada em "CacheIndex".
        ...
        ReportAlgorithms = struct( ...
            ...
            'BandWidth', model.UserData.getFieldTemplate('DefaultAlgorithm: BandWidth') ...
        )

classdef UserData
    ...
    properties
        ...
        CalibrationCurve = table( ...
            ...
            'VariableNames', {'Name', 'Type', 'PreviousLevelUnit', 'CurrentLevelUnit'} ...
        )
        ...
        Emissions = table( ...
            ...
            struct('AutoSuggested', {}, 'UserModified', {}), ...
            struct('DriveTest', {}, 'SignalAnalysis', {}), ...
            'VariableNames', {'Frequency', 'FrequencyIdx', 'BandWidthkHz', 'IsTruncated', 'Description', 'Algorithms', 'Measures', 'ChannelAssigned', 'Classification', 'AuxAppData'} ...
        )
            ...
            switch dataType
                ...
                case 'DefaultAlgorithm: Detection'
                    fieldTemplate = struct('ManualMode', varargin{1}, ...
                                           ...
                                           'Parameters', rmfield(util.Detection.findConnectedRegionsDefaultValues, 'Algorithm'));

    ...
    methods
        ...
        function referenceTable = buildSpectrumReferenceTable(obj, generalSettings, includeDisabledFlows)
            ...
            referenceTable = table( ...
                'Size', [0, 17], ...
                'VariableTypes', {'cell', 'double', 'double', 'cell', 'cell', 'double', 'cell', 'double', 'double', 'cell', 'logical', 'double', 'double', 'datetime', 'cell', 'logical', 'logical'}, ...
                'VariableNames', {'Idx', 'FileIdx', 'FlowIdx', 'File', 'RelatedFiles', 'Id', 'Receiver', 'FreqStart', 'FreqStop', 'Band', 'GpsStatus', 'Latitude', 'Longitude', 'BeginTime', 'Hash', 'IsOccupancyFlow', 'IsEnable'} ...
            );

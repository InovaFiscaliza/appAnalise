    ...
    methods
        ...
        function referenceTable = buildSpectrumReferenceTable(obj, generalSettings, includeDisabledFlows)
            ...
            referenceTable = table( ...
                'Size', [0, 11], ...
                'VariableTypes', {'cell', 'cell', 'cell', 'double', 'cell', 'double', 'double', 'cell', 'double', 'double', 'cell'}, ...
                'VariableNames', {'Idx', 'File', 'RelatedFiles', 'Id', 'Receiver', 'FreqStart', 'FreqStop', 'Band', 'Latitude', 'Longitude', 'Hash'} ...
            );

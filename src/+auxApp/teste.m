classdef winSignalAnalysis < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createRFLinkPlot(app, selectedRow, flowIdx)
            try
                ...
                txJson = jsondecode(specData.UserData.Emissions.Classification(emissionIdx).UserModified.Details);
                ...
                preditionData = struct('modeloPredicao', modelDict("ITU P526"), ...
                    ...
                    'dadosRelevo',   wayPoints3D(:,3), ... %confirmar acho q é índice 1
                ...
                if exist('msgWarning', 'var') && ~isempty(msgWarning)
                    msgText = { ...
                        'PERFIL DE TERRENO ENTRE RECEPTORA';  ...
                        'E PROVÁVEL EMISSOR INDISPONÍVEL';  ...
                        sprintf('(%s)', msgWarning) ...
                        };
                else
                    msgText = { ...
                        'PERFIL DE TERRENO ENTRE RECEPTORE';  ...
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SelectedEmissionPanel.BorderType = 'etchedin';
            ...
            app.TXLocationPanel.BorderType = 'etchedin';
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = winSignalAnalysis(varargin)

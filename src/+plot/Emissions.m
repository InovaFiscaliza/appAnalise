        ...
        function emissionSelected = draw(emissionSelectedIdx, axesHandle, restoreView, bandObj)
            ...
            if ~isempty(emissions)
                ...
                for ii = 1:height(emissions)
                    ...
                    % do plot.
                    line( ...
                        axesHandle, [freqStart, freqStop], [yLevel1, yLevel1], ...
                    ...
                    if ii == emissionSelectedIdx
                        ...
                        emissionSelected = images.roi.Rectangle( ...
                            axesHandle, ...
        ...
        function TStyle(axesHandle, bandObj, plotTag)
            ...
            if ~isempty(emissions)
                ...
                for ii = 1:height(emissions)
                    ...
                    line(axesHandle, [freqStart, freqStop], [yLevel2Plot, yLevel2Plot], 'Color', '#ffff12', 'LineWidth', 1, 'Marker', '.', 'MarkerSize', 8, 'PickableParts', 'none', 'Tag', 'emission');
                    % line(axesHandle, [freqCenter, freqCenter], [-1000, 1000], 'Color', '#ffff12', 'LineWidth', 1, 'LineStyle', ':', 'PickableParts', 'none', 'Tag', 'emission');
                    text(axesHandle, freqStart, yLevel2Plot + min(diff(axesHandle.YLim)*.01, 1), sprintf('%d', ii), Color='#ffff12', FontSize=10, FontWeight='bold', FontName='Helvetica', VerticalAlignment='bottom', Tag='emission');
                end
